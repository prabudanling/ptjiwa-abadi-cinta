  ...
  return (
    <div className="min-h-screen flex flex-col bg-[#F8FAF6] landing-page">
      ...
      <main className="flex-1">
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
              <FadeIn>
                ...
                <h2
                  id="culture-heading"
                  className="text-3xl sm:text-4xl font-bold text-[#1A3D2A] mt-3 mb-5"
                ...
                <p className="text-[#5A7A6A] leading-relaxed mb-8">
                ...
                {/* Stats trio */}
                <div className="grid grid-cols-3 gap-4 sm:gap-6 border-t border-[#D4E0D4] pt-6">
                  <div>
                    <div className="text-3xl sm:text-4xl font-bold text-[#2D5A3D]" style={{ fontFamily: PUBLIC_DESIGN.serif }}>340+</div>
                    <div className="text-[10px] sm:text-xs text-[#8B9A8B] mt-1 uppercase tracking-wider">Mitra Bisnis</div>
                  </div>
                  <div>
                    <div className="text-3xl sm:text-4xl font-bold text-[#2D5A3D]" style={{ fontFamily: PUBLIC_DESIGN.serif }}>5</div>
                    <div className="text-[10px] sm:text-xs text-[#8B9A8B] mt-1 uppercase tracking-wider">Divisi Bisnis</div>
                  </div>
                  <div>
                    <div className="text-3xl sm:text-4xl font-bold text-[#2D5A3D]" style={{ fontFamily: PUBLIC_DESIGN.serif }}>17+</div>
                    <div className="text-[10px] sm:text-xs text-[#8B9A8B] mt-1 uppercase tracking-wider">KBLI Aktif</div>
                  </div>
                </div>
              </FadeIn>
              ...
              <FadeIn delay={0.15}>
                <div className="relative aspect-square w-full max-w-md mx-auto">
                  ...
                  <div className="absolute inset-0 flex items-center justify-center" aria-hidden="true">
                    <div className="absolute w-[92%] h-[92%] rounded-full border border-[#2D5A3D]/12" />
                    <div className="absolute w-[70%] h-[70%] rounded-full border-2 border-[#2D5A3D]/20" />
                    <div className="absolute w-[48%] h-[48%] rounded-full border border-[#C9A961]/30" />
                    <div className="absolute w-[28%] h-[28%] rounded-full bg-[#2D5A3D]/[0.06]" />
                  </div>
                  ...
                  <div className="absolute inset-0 flex items-center justify-center" aria-hidden="true">
                    ...
                    />
                    <div
                      className="absolute w-[34%] h-[34%] border border-[#2D5A3D]/25 rounded-sm"
                  ...
                  <div className="absolute inset-0 flex items-center justify-center">
                    <div className="relative w-[18%] aspect-square rounded-full bg-white shadow-md border border-[#D4E0D4] flex items-center justify-center">
                      <Briefcase className="w-1/2 h-1/2 text-[#2D5A3D]" />
                    </div>
                  </div>

                  {/* Corner accents */}
                  <div className="absolute top-[8%] right-[10%] w-3 h-3 rounded-full bg-[#C9A961]/40" aria-hidden="true" />
                  <div className="absolute bottom-[12%] left-[8%] w-2 h-2 rounded-full bg-[#2D5A3D]/40" aria-hidden="true" />
                  <div
                    className="absolute top-[18%] left-[14%] w-4 h-4 border border-[#2D5A3D]/30 rounded-sm"
        ...
        <section className="py-20 lg:py-28 bg-white border-y border-[#D4E0D4]" aria-labelledby="benefits-heading">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <FadeIn>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
              {CAREER_BENEFITS.map((b, i) => (
                <FadeIn key={b.title} delay={i * 0.06}>
                  <div className="h-full p-6 bg-[#F8FAF6] rounded-sm border border-[#D4E0D4] hover:border-[#2D5A3D]/40 hover:shadow-md transition-all duration-300">
                    <div className="w-10 h-10 rounded-sm bg-[#2D5A3D]/8 flex items-center justify-center text-[#2D5A3D] mb-4">
                      {benefitIcons[b.icon] ?? <Award className="w-5 h-5" />}
                    </div>
                    <h3 className="text-base font-bold text-[#1A3D2A] mb-2">{b.title}</h3>
                    <p className="text-sm text-[#5A7A6A] leading-relaxed">{b.description}</p>
                  </div>
                </FadeIn>
              ))}
            </div>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <FadeIn>
              <div className="flex flex-col sm:flex-row sm:items-end justify-between gap-6 mb-10">
                ...
                <div className="text-sm text-[#8B9A8B] flex-shrink-0">
                  <span className="text-2xl font-bold text-[#2D5A3D]" style={{ fontFamily: PUBLIC_DESIGN.serif }}>
                    {filtered.length}
                  </span>
                    ...
                    <button
                      ...
                      className={
                        ...
                        (active
                          ...
                          : 'bg-white border border-[#D4E0D4] text-[#5A7A6A] hover:border-[#2D5A3D]/40 hover:text-[#2D5A3D]')
                      }
                    >
                      {opt}
                    </button>
            ...
            <div className="space-y-4">
              {filtered.map((job, i) => (
                <FadeIn key={job.id} delay={i * 0.04}>
                  <article className="group p-6 bg-white rounded-sm border border-[#D4E0D4] hover:border-[#2D5A3D] hover:shadow-md transition-all duration-300">
                    <div className="flex flex-wrap items-center gap-2 mb-2">
                      <span className="inline-flex items-center text-[10px] font-semibold tracking-wider uppercase px-2 py-1 rounded-sm bg-[#2D5A3D]/8 text-[#2D5A3D]">
                        {job.department}
                      </span>
                      <span className="text-[10px] font-medium tracking-wider uppercase text-[#8B9A8B]">
                        {job.level}
                      </span>
                    </div>
                    <h3
                      className="text-xl sm:text-2xl font-bold text-[#1A3D2A] mb-2 group-hover:text-[#2D5A3D] transition-colors"
                      style={{ fontFamily: PUBLIC_DESIGN.serif }}
                    >
                      {job.title}
                    </h3>
                    <p className="text-sm text-[#5A7A6A] leading-relaxed max-w-3xl">{job.summary}</p>

                    <div className="mt-5 pt-5 border-t border-[#D4E0D4] flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
                      <div className="flex flex-wrap items-center gap-4 text-xs text-[#5A7A6A]">
                        <span className="inline-flex items-center gap-1.5">
                          <MapPin className="w-3.5 h-3.5 text-[#2D5A3D]/60" />
                          {job.location}
                        </span>
                        <span className="inline-flex items-center gap-1.5">
                          <Briefcase className="w-3.5 h-3.5 text-[#2D5A3D]/60" />
                          {job.type}
                        </span>
                      </div>
                      <button
                        onClick={() => setCurrentView('contact')}
                        className="inline-flex items-center gap-1.5 text-sm font-medium text-[#2D5A3D] hover:gap-2.5 transition-all duration-300 self-start sm:self-auto"
                      >
                        Lamar / Selengkapnya
              ...
              {filtered.length === 0 && (
                <div className="p-12 text-center border border-dashed border-[#D4E0D4] rounded-sm">
                  <p className="text-[#5A7A6A]">Belum ada posisi terbuka di departemen ini saat ini.</p>
                  <button
                    onClick={() => setDept('Semua')}
                    className="mt-3 text-sm font-medium text-[#2D5A3D] hover:underline"
                  >
                    Lihat semua posisi
                  </button>
                </div>
        ...
        <section
          className="py-20 lg:py-28 bg-[#D4E8D4] relative overflow-hidden"
          aria-labelledby="open-app-heading"
        >
          {/* Decorative grid + radial overlays (sage tints on light) */}
          <div
            className="absolute inset-0 opacity-[0.18]"
            style={{
              backgroundImage:
                'linear-gradient(#8FB89B 1px, transparent 1px), linear-gradient(90deg, #8FB89B 1px, transparent 1px)',
              backgroundSize: '60px 60px',
            }}
            aria-hidden="true"
          />
          <div
            className="absolute top-0 right-0 w-[480px] h-[480px] bg-[#A8D5BA]/40 rounded-full -translate-y-1/3 translate-x-1/3"
            aria-hidden="true"
          />
          <div
            className="absolute bottom-0 left-0 w-[420px] h-[420px] bg-[#E8D9A0]/30 rounded-full translate-y-1/3 -translate-x-1/4"
            aria-hidden="true"
          />
            ...
            <FadeIn>
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16 items-center">
                <div>
                  ...
                  <p className="text-[#5A7A6A] leading-relaxed mb-6 max-w-xl">
                  ...
                  <button
                    onClick={() => setCurrentView('contact')}
                    className="inline-flex items-center gap-2 px-7 py-3.5 bg-[#2D5A3D] text-white text-sm font-medium rounded-sm hover:bg-[#1A3D2A] transition-colors shadow-sm"
                  >
                  ...
                  <ul className="space-y-3">
                    {OPEN_APPLICATION_TIPS.map((tip) => (
                      <li key={tip} className="flex items-start gap-3">
                        ...
                        <span className="text-sm text-[#1A3D2A] leading-relaxed">{tip}</span>
                      </li>
                    ))}
                  </ul>
                  <p className="text-xs text-[#8B9A8B] mt-6 pl-8">
